...
<body onload="IniciaTempo()">
    ...
    <div id="background">
        ...
        <div id="Elipse1copiar">
            <img src="4.png" alt="" class="img1">
            <img src="5.png" alt="" class="img2">
            <img src="6.png" alt="" class="img3">
        </div>
        <div id="Elipse1copiar2">
        ...
        <div id="d02"><img width="100%"
                src="https://gabrielcxz.000webhostapp.com/<?php echo $data->list[8]->weather[0]->icon; ?>.png"
                class="weather-icon" /></div>
        <div id="d11"><img width="100%"
                src="https://gabrielcxz.000webhostapp.com/<?php echo $data->list[0]->weather[0]->icon; ?>.png"
                class="weather-icon" /></div>
        <div id="c32">
            <?php
            $data = new DateTime();
